...
var FEATURES = [
  ...
  ["task-timeline", "Menu tương tác timeline entry", "Mỗi entry vừa tạo/kết thúc kèm inline keyboard: sửa tên, ghi chú, giờ bắt đầu/kết thúc, đổi ngày, xoá — bấm nút rồi gõ giá trị ở ô chat thường, tự lưu ngay không cần bước xác nhận", "(nút dưới mỗi hoạt động)", "live", "v0.1.10"],
  ...
  ["task-timeline", "Chọn entry từ /timeline mở menu đầy đủ", "Mỗi dòng trong /timeline là 1 nút bấm; chọn 1 entry mở đúng menu đầy đủ (sửa tên/ghi chú/giờ bắt đầu-kết thúc/đổi ngày/xoá); xoá xong tự quay lại danh sách ngày đó thay vì thoát hẳn", "/timeline → bấm 1 dòng trong danh sách", "live", "v0.1.12"],
  ...
  ["task-timeline", "Xem timeline theo tuần", "Tóm tắt 7 ngày T2→CN: tổng giờ tracked + số entries + top 3 hoạt động nổi bật nhất mỗi ngày; bấm 1 ngày để xem chi tiết (dùng lại flow /timeline dd/mm)", "/timeline tuần này · /timeline tuần trước · /timeline tuần 28/07", "live", "v0.1.14"],
  ["task-timeline", "Menu timeline tự lưu, bỏ nút xác nhận", "Bỏ nút '✅ Xác nhận & lưu' khỏi menu — mỗi thao tác sửa tên/ghi chú/giờ/ngày tự lưu ngay sau khi nhập, vẽ lại menu luôn; menu chỉ còn nút hành động thực sự (sửa/xoá/kết thúc ngay)", "(nút dưới mỗi hoạt động)", "live", "v0.1.15"]
];
